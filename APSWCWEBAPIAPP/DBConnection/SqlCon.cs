...
namespace APSWCWEBAPIAPP.DBConnection
{
    public class SqlCon
    {
        ...
        public SqlCon(IConfiguration configuration, ApplicationAPSWCCDbContext apcontext, ICaptchaService auth)
        {
            ...
            savePath = Path.Combine(Directory.GetCurrentDirectory(), saFolder);
        ...
        public async Task<dynamic> InsuranceCmpnywiseDetails(MasterSp rootobj)
        {
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "InsuranceCmpnywiseDetailslogs", "InsuranceCmpnywiseDetails : Method:" + jsondata + " , Input Data : " + inputdata));
        ...
        public async Task<dynamic> TestMail1(MasterSp objMa)
        {
            try
            {
                ...
                if (domain == "@ap.gov.in")
                {
                    ...
                    MailMessage mail = new MailMessage();
                    SmtpClient SmtpServer = new SmtpClient("relay.nic.in");
                    mail.From = new MailAddress("gmit-apswc@ap.gov.in");//userid
        ...
        public async Task<dynamic> GetWHCapacityDetails(MasterSp rootobj)
        {
            ...
            try
            {
                ...
                rootobj.DIRECTION_ID = "4";
                rootobj.TYPEID = "WH_CAPACITY_AVAILABILITY";
                DataTable dt = await APSWCMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
            ...
            catch (Exception ex)
            {
                ...
                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while load WHCapacity Details";
                return resultobj;
        ...
        public async Task<dynamic> GetCompartmentlistforleased(MasterSp rootobj)
        {
            ...
            try
            {
                ...
                rootobj.DIRECTION_ID = "4";
                rootobj.TYPEID = "TO_LOCK_COMPARTMENTS";
                DataTable dt = await APSWCMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
            ...
            catch (Exception ex)
            {
                ...
                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while load Compartment Details";
                return resultobj;
        ...
        public async Task<dynamic> SaveWH_InsuranceDetails(MasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "5";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "SaveWH_InsuranceDetailslogs", "SaveWH_InsuranceDetails : Method:" + jsondata + " , Input Data : " + inputdata));
        ...
        public async Task<dynamic> APSWCMapsServiceConsume(DigiLocker root)
        {
            string input = "";
            ...
            try
            {
                input = "TYPEID=" + root.TYPEID + "&INPUT_01=" + root.INPUT_01 + "&DIRECTION_ID=" + root.DIRECTION_ID + "&INPUT_02=" + root.INPUT_02 + "&INPUT_03=" + root.INPUT_03 + "&INPUT_04=" + root.INPUT_04 + "&INPUT_05=" + root.INPUT_05 + "&INPUT_06=" + root.INPUT_06 + "&INPUT_07=" + root.INPUT_07 + "&INPUT_08=" + root.INPUT_08 + "&INPUT_09=" + root.INPUT_09 + "&INPUT_10=" + root.INPUT_10 + "&INPUT_11=" + root.INPUT_11 + "&INPUT_12=" + root.INPUT_12 + "&INPUT_13=" + root.INPUT_13;

                var data1 = await PostDataAPSWC(_mapsserverpath + "/api/LatLong/PDFGenerationRPT", input, root.token);
                string data = JsonConvert.SerializeObject(data1);
                ...
                else
                {
                    ...
                    obj_data.Reason = "Data Fetching Failed";
                    obj_data.CertIssuerData = data1;
                }
        ...
        public async Task<dynamic> UpdateLoanDetails(MasterSp rootobj)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "UpdateLoanDetailsLogs", "UpdateLoanDetails : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Save Bank Loan Details";
                return resultobj;

            }
        }

        public async Task<dynamic> UpdateLoanRepaymentDetails(MasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "12";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "UpdateLoanRepaymentDetailsLogs", "UpdateLoanRepaymentDetails : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Save Bank Loan Re-payment Details";
                return resultobj;
        ...
        public async Task<dynamic> DashboardDetails(MasterSp rootobj)
        {

            try
            {
                rootobj.DIRECTION_ID = "19";
                rootobj.TYPEID = rootobj.INPUT_01;
                DataTable dt = await APSWCMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
            ...
            catch (Exception ex)
            {
                ...
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "DashboardDetailsLogs", "DashboardDetails : Method:" + jsondata + " , Input Data : " + inputdata));
                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while load Dashboard Details";
                return resultobj;
        ...
        public async Task<dynamic> HRDashboardDetails(MasterSp rootobj)
        {

            try
            {
                rootobj.DIRECTION_ID = "21";
                rootobj.TYPEID = rootobj.INPUT_01;
                DataTable dt = await APSWCMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
            ...
            catch (Exception ex)
            {
                ...
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "HRDashboardDetailsLogs", "HRDashboardDetails : Method:" + jsondata + " , Input Data : " + inputdata));
        ...
        public async Task<dynamic> GetPriorityData(MasterSp rootobj)
        {

            try
            {
                rootobj.DIRECTION_ID = "13";
                rootobj.TYPEID = "PRIORITY_REGISTER";
                DataTable dt = await APSWCMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
            ...
            catch (Exception ex)
            {
                ...
                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while load Priority Register Details";
                return resultobj;

            }
        }

        public async Task<dynamic> GetStorageChargesData(MasterSp rootobj)
        {

            try
            {
                rootobj.DIRECTION_ID = "13";
                rootobj.TYPEID = "INVOICE_DEDUCTION_REPORT";
                DataTable dt = await APSWCMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
            ...
            catch (Exception ex)
            {
                ...
                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while load Storage Charges Details";
                return resultobj;
        ...
        public async Task<dynamic> GetSpillageStack(MasterSp rootobj)
        {
            //MasterSp rootobj = new MasterSp();
            try
            {
                rootobj.DIRECTION_ID = "12";
                rootobj.TYPEID = "GET_SPILLAGE_STACKS";
            ...
            catch (Exception ex)
            {
                ...
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GetSpillageStackLogs", "GetSpillageStack : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Load Stacks Details";
        ...
        public async Task<dynamic> GetHospitalslist(EmployeeMasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "101";
                rootobj.TYPEID = "DIST_HOSPITALS";
            ...
            catch (Exception ex)
            {
                ...
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GetHospitalslistLogs", "GetHospitalslist: Method:" + jsondata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Get Hospital List";
                return resultobj;

            }
        }
        public async Task<dynamic> GetDiseaselist()
        {
            MasterSp rootobj = new MasterSp();
            try
            {
                rootobj.DIRECTION_ID = "6";
                rootobj.TYPEID = "TREATMENT";
                DataTable dt = await APSWCMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
                ...
                {
                    resultobj.StatusCode = 102;
                    resultobj.StatusMessage = "No Disease Details Found";
                }
            ...
            catch (Exception ex)
            {
                ...
                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while load Disease List";
                return resultobj;

            }
        }

        public async Task<dynamic> GetFamilyNames(EmployeeMasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "101";
                rootobj.TYPEID = "EMP_RELATION";
            ...
            catch (Exception ex)
            {
                ...
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GetFamilyNamesLogs", "GetFamilyNames: Method:" + jsondata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Get Family Names List";
                return resultobj;

            }
        }

        public async Task<dynamic> GetTreatmentType(EmployeeMasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "101";
                rootobj.TYPEID = "TREATMENT_AMOUNT";
            ...
            catch (Exception ex)
            {
                ...
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GetTreatmentTypeLogs", "GetTreatmentType: Method:" + jsondata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Load Treatment Types";
                return resultobj;

            }
        }

        public async Task<dynamic> GetMedicalReqList(EmployeeMasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "101";
                rootobj.TYPEID = "EMP_MEDICAL";
            ...
            catch (Exception ex)
            {
                ...
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GetMedicalReqListLogs", "GetMedicalReqList: Method:" + jsondata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Load Medical Request List";
                return resultobj;

            }
        }

        public async Task<dynamic> GetMedicalApprovalList(EmployeeMasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "101";
                rootobj.TYPEID = "EMP_APPROVAL";
            ...
            catch (Exception ex)
            {
                ...
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GetMedicalApprovalListLogs", "GetMedicalApprovalList: Method:" + jsondata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Get Medical Approval List";
                return resultobj;

            }
        }

        public async Task<dynamic> SaveMedicalRequest(EmployeeMasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "101";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "SaveMedicalRequestLogs", "SaveMedicalRequest : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Save Medical Request Information";
                return resultobj;
        ...
        public async Task<dynamic> GetInvoiceMasterDetails(MasterSp rootobj)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "Invoicemasterlogs", "Invoicemasterlogs: Method:" + jsondata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Load Warehouse Invoice Master Details";
                return resultobj;
        ...
        public async Task<dynamic> SaveInvoiceModeDetails(MasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "6";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log_Exception(exPathToSave, "Invoicemasterlogs : Method:" + jsondata + " , Input Data : " + inputdata));
        ...
        public async Task<dynamic> GetCommpodityGrouplist(MasterSp objMa)
        {
            //MasterSp rootobj = new MasterSp();
            try
            {
                objMa.DIRECTION_ID = "6";
                objMa.TYPEID = "GET_COMMODITY_GROUP";
                DataTable dt = await APSWCMasterSp(objMa);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(objMa);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log_Exception(exPathToSave, "CommodityGrouplist : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while load Commodity Group Types";
                return resultobj;
            }
        }

        public async Task<dynamic> GetCommpoditynamelist(MasterSp objMa)
        {
            //MasterSp rootobj = new MasterSp();
            try
            {
                objMa.DIRECTION_ID = "6";
                objMa.TYPEID = "GET_COMMODITY";
                DataTable dt = await APSWCMasterSp(objMa);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
        ...
        public async Task<dynamic> SaveOverandAboveDetails(MasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "6";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log_Exception(exPathToSave, "SaveOverandAbovelogs : Method:" + jsondata + " , Input Data : " + inputdata));
        ...
        public async Task<dynamic> updatecommodprcDetails(MasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "6";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log_Exception(exPathToSave, "updatecommoditypricelogs : Method:" + jsondata + " , Input Data : " + inputdata));
        ...
        public async Task<dynamic> GetDepositoryDetails(MasterSp rootobj)
        {
            try
            {
        ...
        public async Task<dynamic> SaveRebatepriceDetails(MasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "6";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log_Exception(exPathToSave, "RebateDetailslogs : Method:" + jsondata + " , Input Data : " + inputdata));
        ...
        public async Task<dynamic> GetrebatelistDetails(MasterSp rootobj)
        {
            try
            {
        ...
        public async Task<dynamic> GetoverandabvDetails(MasterSp rootobj)
        {
            try
            {
                ...
                rootobj.DIRECTION_ID = "6";
                rootobj.TYPEID = "COMMODITY_PERCENTAGE";
        ...
        public async Task<dynamic> updaterebatDetails(MasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "6";
        ...
        public async Task<dynamic> updateoverandaboveDetails(MasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "6";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log_Exception(exPathToSave, "updateoverandabovelogs : Method:" + jsondata + " , Input Data : " + inputdata));
        ...
        #region Medical Reimbursement
        public async Task<dynamic> Getmedicalreimbursement(MasterSp rootobj)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "MedicalReimbursementlogs", "MedicalReimbursementlogs: Method:" + jsondata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Load Medical Reimbursement Master Details";
                return resultobj;
        ...
        public async Task<dynamic> SaveHospitalsDetails(MasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "6";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log_Exception(exPathToSave, "SaveHospitalsDetailslogs : Method:" + jsondata + " , Input Data : " + inputdata));
        ...
        public async Task<dynamic> SaveDiseaseDetails(MasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "6";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log_Exception(exPathToSave, "SaveDiseaseDetailslogs : Method:" + jsondata + " , Input Data : " + inputdata));
        ...
        public async Task<dynamic> updatehospitallistDetails(MasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "6";
        ...
        public async Task<dynamic> updateDiseaselistDetails(MasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "6";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log_Exception(exPathToSave, "updateDiseaselogs : Method:" + jsondata + " , Input Data : " + inputdata));
        ...
        public async Task<dynamic> GetHospitaldetails(EmployeeMasterSp rootobj)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "HospitalDetailslogs", "HospitalDetailslogs: Method:" + jsondata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Load Hospital Details";
                return resultobj;

            }
        }

        public async Task<dynamic> Gettreatmentdetails(EmployeeMasterSp rootobj)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "TreatmenttypeDetailslogs", "TreatmenttypeDetailslogs: Method:" + jsondata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Load Treatmenttype Details";
                return resultobj;
        ...
        public async Task<dynamic> Getfamilyrelationdetails(EmployeeMasterSp rootobj)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "Familydetailslogs", "Familydetailslogs: Method:" + jsondata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Load Familydetails Details";
                return resultobj;

            }
        }

        public async Task<dynamic> Getfamilydetails(EmployeeMasterSp rootobj)
        {
            try
            {
        ...
        public async Task<dynamic> GetNameslist(EmployeeMasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "101";
                rootobj.TYPEID = "DD_OFFICER_NAME";
            ...
            catch (Exception ex)
            {
                ...
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GetNameslistLogs", "GetNameslist: Method:" + jsondata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Get Names List";
                return resultobj;
        ...
        public async Task<dynamic> GetDesignationlist(EmployeeMasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "101";
                rootobj.TYPEID = "DD_DESIGNATION";
            ...
            catch (Exception ex)
            {
                ...
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GetDesignationlistLogs", "GetDesignationlist: Method:" + jsondata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Get Designation List";
                return resultobj;
        ...
        public async Task<dynamic> SaveMedicalApprovalDetails(EmployeeMasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "101";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "SaveMedicalApprovalLogs", "SaveMedicalApproval : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Save Medical Approval Information";
                return resultobj;
        ...
        public async Task<dynamic> Savemedicaldetails(EmployeeMasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "101";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "SaveMedivcalDetailsLogs", "SaveMedivcalDetailsLogs : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Save Medical Approval Details";
                return resultobj;
        ...
        public async Task<dynamic> GetApplicationDetails(EmployeeMasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "101";
                rootobj.TYPEID = "GGH_DOC_UPLOAD_GET";
            ...
            catch (Exception ex)
            {
                ...
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GetApplicationDetailsLogs", "GetApplicationDetails: Method:" + jsondata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Get Application Details";
                return resultobj;

            }
        }

        public async Task<dynamic> SaveSanctionedDetails(EmployeeMasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "101";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "SaveSanctionedDetailsLogs", "SaveSanctionedDetails : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Save Medical Sanctioned Documents Information";
                return resultobj;

            }
        }

        public async Task<dynamic> GetMedicalRAHistory(EmployeeMasterSp rootobj)
        {

            try
            {
                rootobj.DIRECTION_ID = "101";
                rootobj.TYPEID = rootobj.INPUT_02 == "REQ_HISTORY" ? "EMP_MEDICAL_HISTORY" : rootobj.INPUT_02 == "APPR_HISTORY" ? "EMP_APPROVAL_HISTORY" : "";
            ...
            catch (Exception ex)
            {
                ...
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GetMedicalRAHistoryLogs", "GetMedicalRAHistory: Method:" + jsondata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Getting Medical Request/Approval History Details";
                return resultobj;
        ...
        public async Task<dynamic> GetWHInvoiceDetails(MasterSp rootobj)
        {
        ...
        public async Task<dynamic> GetInvoicesList(MasterSp rootobj)
        {

            try
            {
                rootobj.DIRECTION_ID = "23";
                rootobj.TYPEID = "101";
                DataTable dt = await APSWCMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
        ...
        public async Task<dynamic> GetInvoiceIDDetails(MasterSp rootobj)
        {
...

        {
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "SaveDeductionDetailsLogs", "SaveDeductionDetails : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Save Deductions Details";
                return resultobj;

            }
        }

        public async Task<dynamic> GetDeductionDetails(MasterSp rootobj)
        {
            ...
            catch (Exception ex)
            {
                ...
                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while load Deductions Details";
                return resultobj;
        ...
        #region H & T Contractos Details

        public async Task<dynamic> SaveHTDetails(MasterSp rootobj)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "SaveHTDetailslogs", "SaveHTDetails : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Save H & T Contractors Details";
                return resultobj;

            }
        }

        public async Task<dynamic> UpdateHTDetails(MasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "17";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "UpdateHTDetailslogs", "UpdateHTDetails : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Update H&T Contractor Details";
                return resultobj;

            }
        }

        public async Task<dynamic> GetHTDetails(MasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "17";
            ...
            catch (Exception ex)
            {
                ...
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GetHTDetailsLogs", "GetHTDetails : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Get Details of H&T Contractor";
        ...
        public async Task<dynamic> GetHTHistoryDetails(MasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "17";
            ...
            catch (Exception ex)
            {
                ...
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GetHTHistoryDetailsLogs", "GetHTHistoryDetails : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Get History Of H&T Contractor";
        ...
        public async Task<dynamic> Getbanklist(MasterSp objMa)
        {

            try
            {
                objMa.DIRECTION_ID = "1";
                objMa.TYPEID = "MEDICAL_BANK_DETAILS";

                DataTable dt = await APSWCMasterSp(objMa);
                if (dt != null && dt.Rows.Count > 0)
                {
                    if (dt.Rows[0]["IFSC_CODE"].ToString() == "")
                    {
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(objMa);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log_Exception(exPathToSave, "Getbankaccountlogs : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while load Bank Details";
                return resultobj;
            }
        }

        public async Task<dynamic> updatemedicaldetails(EmployeeMasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "101";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "RejectMedicalLogs", "RejectMedicalLogs : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Update Medical Reimbursement Approval Details";
                return resultobj;
        ...
        public async Task<dynamic> GetAssetmanagementsubcategory(MasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "9";
                rootobj.TYPEID = "ASSET_SUBCATEGORY";
            ...
            catch (Exception ex)
            {
                ...
                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Get AssetmanagementSubcategory Details";
                return resultobj;

            }
        }

        public async Task<dynamic> SR_SERVICE_PROFILE(MasterSp rootobj)
        {
            try
            {
                DataSet ds = await APSWCMasterSp_SRGET(rootobj);
                if (ds != null && ds.Tables[0].Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
                    resultobj.StatusMessage = "Data Loaded Successfully";
                    resultobj.Details = ds;
                }
                else
                {
                    resultobj.StatusCode = 102;
            ...
            catch (Exception ex)
            {
                ...
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "SR_SERVICE_PROFILE", "SR_SERVICE_PROFILE : Method:" + jsondata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured  SERVICE_PROFILE Details";
        ...
        public async Task<dynamic> Getbankaccountdetails(MasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "1";
                rootobj.TYPEID = "MEDICAL_BANK_DETAILS";
            ...
            catch (Exception ex)
            {
                ...
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GetbankaccountdetailsLogs", "Getbankaccountdetails : Method:" + jsondata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Get Bank Account Details";
                return resultobj;

            }
        }

        public async Task<dynamic> MedicalApprovalStatus(EmployeeMasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "101";
                rootobj.TYPEID = "ALREADY_UPLOAD_MSG";
            ...
            catch (Exception ex)
            {
                ...
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "MedicalApprovalStatusLogs", "MedicalApprovalStatus: Method:" + jsondata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Get Medical Approval Status";
                return resultobj;

            }
        }

        public async Task<dynamic> GetFamilyRelations(EmployeeMasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "101";
                rootobj.TYPEID = "EMP_FAMILY";
            ...
            catch (Exception ex)
            {
                ...
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GetFamilyRelationsLogs", "GetFamilyRelations: Method:" + jsondata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Get Family Relation Details";
                return resultobj;

            }
        }

        public async Task<dynamic> MedicalUpdateDetails(EmployeeMasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "101";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "MedicalUpdateDetailsLogs", "MedicalUpdateDetails : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Update Medical  Details";
                return resultobj;
        ...
        public async Task<dynamic> SaveWHQuestions(EmployeeMasterSp rootobj)
        {
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "SaveWHQuestionsLogs", "SaveWHQuestions : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Save WareHouse Questions Information";
                return resultobj;

            }
        }

        public async Task<dynamic> GetWHQuestions()
        {
            EmployeeMasterSp rootobj = new EmployeeMasterSp();
            try
            {
                rootobj.DIRECTION_ID = "102";
            ...
            catch (Exception ex)
            {
                ...
                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Get WareHouse Questions List";
                return resultobj;

            }
        }

        public async Task<dynamic> GetGeneralInspectionData(EmployeeMasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "102";
                rootobj.TYPEID = "GENERAL_INSPECTION";

                DataSet ds = await EmployeeAPSWCMasterSp_VIGet(rootobj);
            ...
            catch (Exception ex)
            {
                ...
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GeneralInspectionLogs", "GeneralInspection: Method:" + jsondata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Get General Inspection Information";
                return resultobj;
        ...
        public async Task<dynamic> DeadStockApproval(MasterSp objMa)
        {
            ...
            catch (Exception ex)
            {
                ...
                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Insert Data";
                return resultobj;
            }
        }
        ...
        public async Task<dynamic> SavePendingWHMemosDetails(MasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "12";
            ...
            catch (Exception ex)
            {
                ...
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "SavePendingWHMemosDetailsLogs", "SavePendingWHMemosDetails : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Save Pending Warehouse Weight Memo Details";
                return resultobj;
        ...
        public async Task<dynamic> GetStocksList(MasterSp rootobj)
        {
            ...
            {
                rootobj.DIRECTION_ID = "7";
                rootobj.TYPEID = "EXISTING_RECORDS_GET";
        ...
        public async Task<dynamic> SaveExistingStockDetails(MasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "7";
            ...
            catch (Exception ex)
            {
                ...
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "SaveExistingStockDetailsLogs", "SaveExistingStockDetails : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Save Existing Stock Details";
                return resultobj;
        ...
        public async Task<dynamic> SaveemployeeloanApproveDetails(EmployeeMasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "101";
            ...
            catch (Exception ex)
            {
                ...
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "loanApproveDetailsLogs", "loanApproveDetails : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Save Employee Loan Approval Details";
                return resultobj;

            }
        }

        public async Task<dynamic> updateemployeeloanApproveDetails(EmployeeMasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "101";
            ...
            catch (Exception ex)
            {
                ...
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "loanUpdateDetailsLogs", "loanUpdateDetails : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Update Employee Loan Approval Details";
                return resultobj;

            }
        }

        public async Task<dynamic> Saveemployeeloandetais(EmployeeMasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "101";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "SaveemployeeloanSDetailslogs", "SaveemployeeloanSDetailslogs : Method:" + jsondata + " , Input Data : " + inputdata));
        ...
        public async Task<dynamic> GetQRResponse(MasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "1";
                rootobj.TYPEID = "QR_RESPONSE";
                DataTable dt = await APSWCMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0 && dt.Rows[0][0].ToString() == "1")
                {
                    resultobj.StatusCode = 100;
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GetQrResponselogs", "GetQrResponse : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Get QR Response";
                return resultobj;

            }
        }

        public async Task<dynamic> GetLoanRAHistory(EmployeeMasterSp rootobj)
        {

            try
            {
                rootobj.DIRECTION_ID = "101";
                rootobj.TYPEID = rootobj.INPUT_02 == "REQ_HISTORY" ? "EMP_LOAN_HISTORY" : rootobj.INPUT_02 == "APPR_HISTORY" ? "EMP_LOAN_REQ_HISTORY" : "";
            ...
            catch (Exception ex)
            {
                ...
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GetLoanRAHistoryLogs", "GetLoanRAHistory: Method:" + jsondata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Getting Employee Loan Request/Approval History Details";
                return resultobj;

            }
        }

        public async Task<dynamic> GetVersionCheck(MasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "8";
                rootobj.TYPEID = "VERSION_GET";
                DataTable dt = await APSWCMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0 && dt.Rows[0][0].ToString() == "1")
                {
                    resultobj.StatusCode = 100;
                    resultobj.StatusMessage = "You're Using Latest Version";
                    resultobj.Details = dt;
                }
                else
                {
                    resultobj.StatusCode = 102;
                    resultobj.StatusMessage = dt.Rows[0][1].ToString();
                    resultobj.APK_URL = dt.Rows[0][2].ToString();
                }
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log_Exception(exPathToSave, "GetVersionCheckLogs : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Get Mobile Version";
                return resultobj;
        ...
        public async Task<dynamic> GetFumigationSprayingRegister(MasterSp rootobj)
        {

            try
            {
                rootobj.DIRECTION_ID = "13";
                rootobj.TYPEID = "SPRAYING_FUMIGATION_REPORT";
                DataTable dt = await APSWCMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GetFumigationSprayingRegisterLogs", "GetFumigationSprayingRegister : Input Data : " + inputdata + ", Method:" + jsondata));
        ...
        public async Task<dynamic> GetGateRegister(MasterSp rootobj)
        {

            try
            {
                rootobj.DIRECTION_ID = "13";
                rootobj.TYPEID = "GATE_REGISTER";
                DataTable dt = await APSWCMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GetGateRegisterLogs", "GetGateRegister : Input Data : " + inputdata + ", Method:" + jsondata));
        ...
        public async Task<dynamic> GetReceiptIssueCancellation(MasterSp rootobj)
        {

            try
            {
                rootobj.DIRECTION_ID = "13";
                rootobj.TYPEID = "RECEIPT_CANCELATION";
                DataTable dt = await APSWCMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GetReceiptIssueCancellationLogs", "GetReceiptIssueCancellation : Input Data : " + inputdata + ", Method:" + jsondata));
        ...
        public async Task<dynamic> GetGunnyRegister(MasterSp rootobj)
        {

            try
            {
                rootobj.DIRECTION_ID = "13";
                rootobj.TYPEID = "GUNNY_BAG_REGISTER_GET";
                DataTable dt = await APSWCMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GetGunnyRegisterLogs", "GetGunnyRegister : Input Data : " + inputdata + ", Method:" + jsondata));
        ...
        public async Task<dynamic> GetDepositorCommodities(MasterSp rootobj)
        {

            try
            {
                rootobj.DIRECTION_ID = "13";
                rootobj.TYPEID = "REGISTERED_COMMODITIES";
                DataTable dt = await APSWCMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GetDepositorCommoditiesLogs", "GetDepositorCommodities : Input Data : " + inputdata + ", Method:" + jsondata));
        ...
        public async Task<dynamic> GetAnalysisRegister(MasterSp rootobj)
        {

            try
            {
                rootobj.DIRECTION_ID = "13";
                rootobj.TYPEID = "ANALYSIS_REGISTER";
                DataTable dt = await APSWCMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GetAnalysisRegisterLogs", "GetAnalysisRegister : Input Data : " + inputdata + ", Method:" + jsondata));
        ...
        public async Task<dynamic> GetJointSampleRegister(MasterSp rootobj)
        {

            try
            {
                rootobj.DIRECTION_ID = "13";
                rootobj.TYPEID = "JOINT_SAMPLE_REGISTER";
                DataTable dt = await APSWCMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
        ...
        public async Task<dynamic> GetDeadStockRegister(MasterSp rootobj)
        {

            try
            {
                rootobj.DIRECTION_ID = "13";
                rootobj.TYPEID = "DEAD_STOCK_REGISTER";
                DataTable dt = await APSWCMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GetDeadStockRegisterLogs", "GetDeadStockRegister : Input Data : " + inputdata + ", Method:" + jsondata));
        ...
        public async Task<dynamic> EmpLeaveBalance_Get(MasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "2";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log_Exception(exPathToSave, "EmpLeaveBalance_Get : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Employee Leave Balance Details";
                return resultobj;
        ...
        public async Task<DataSet> EmployeeAPSWCMasterSp_VIGet(EmployeeMasterSp objMa)
        {
            SqlConnection sqlcon = new SqlConnection(_connectionString);
            SqlCommand cmd = new SqlCommand();
            DataTable dt = new DataTable();
        ...
        public async Task<DataSet> APSWCMasterSp_SRGET(MasterSp objMa)
        {
            SqlConnection sqlcon = new SqlConnection(_connectionString);
            SqlCommand cmd = new SqlCommand();
            DataTable dt = new DataTable();
        ...
        public async Task<dynamic> PostDataAPSWC(string url, string input, string token)
        {
            ...
            {
                Task WriteTask1 = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "PostDataAPSWCExceptionLog", "PostDataAPSWC : Method:" + wex.Message.ToString() + " ,  url : " + url + " , Input Data :" + input));
        ...
        public async Task<dynamic> saveempapprovalApproval(EmployeeMasterSp objMa)
        {
            try
            {

                objMa.DIRECTION_ID = "101";
                DataTable dt = await EmployeeAPSWCMasterSp(objMa);
                if (dt != null && dt.Rows.Count > 0)
                {
                    if (dt.Rows[0]["RTN_ID"].ToString() == "1")
                    {
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(objMa);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log_Exception(exPathToSave, "SaveemployeeloanApprovelogs : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while insert the Data";
                return resultobj;
            }
        }


        public async Task<dynamic> loanapprovalupdateApproval(EmployeeMasterSp objMa)
        {
            try
            {
                ...
                if (dt != null && dt.Rows.Count > 0)
                {
                    ...
                    {
                        resultobj.StatusCode = 102;
                        resultobj.StatusMessage = "Data updation Failed";
                    }
                }
                else
                {
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(objMa);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log_Exception(exPathToSave, "updateemployeeloanApprove : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while update Data";
                return resultobj;
            }
        }


        public async Task<dynamic> GetCashBook(MasterSp rootobj)
        {

            try
            {
                rootobj.DIRECTION_ID = "13";
                rootobj.TYPEID = "CASH_BOOK";
                DataTable dt = await APSWCMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
        ...
        public async Task<dynamic> GetHandTReg(MasterSp rootobj)
        {

            try
            {
                rootobj.DIRECTION_ID = "13";
                rootobj.TYPEID = "HAMALIES_TRANSPORT";
                DataTable dt = await APSWCMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
        ...
        public async Task<dynamic> GetInvoiceDepositers(MasterSp rootobj)
        {

            try
            {
                rootobj.DIRECTION_ID = "13";
                rootobj.TYPEID = "HAMALIES_TRANSPORT_REG";
                DataTable dt = await APSWCMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
        ...
        public async Task<dynamic> GetTendersList(MasterSp rootobj)
        {
            ...
            try
            {
                rootobj.DIRECTION_ID = "17";
                DataTable dt = await APSWCMasterSp(rootobj);
                if (rootobj.TYPEID == "301" || rootobj.TYPEID == "304" || rootobj.TYPEID == "302" || rootobj.TYPEID == "303" || rootobj.TYPEID == "305" || rootobj.TYPEID == "306" || rootobj.TYPEID == "307" || rootobj.TYPEID == "308")
                {
                    if (dt != null && dt.Rows.Count > 0 && dt.Rows[0][0].ToString() == "1")
                    {
                        resultobj.StatusCode = 100;
        ...
        #region  save warehouse construction Details
        public async Task<dynamic> SaveWarehousereqdetails(warehousereq rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "20";
                rootobj.TYPEID = "101";
                DataTable dt = await APSWCFINWHCMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0 && dt.Rows[0][0].ToString() == "1")
                {
                    resultobj.StatusCode = 100;
                    resultobj.StatusMessage = "Data Saved Successfully";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "SaveWarehousereqdetails", "SaveWarehousereqdetails : Method:" + jsondata + " , Input Data : " + inputdata));
        ...
        public async Task<dynamic> GETFinWHCDetailsli(WHLoancl rootobj)
        {
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GETFinWHCDetailslilogs", "GETFinWHCDetailsli : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while load WHCDetailsli";
                return resultobj;
        ...
        public async Task<dynamic> GETFWHCTDetailsli(warehousereq rootobj)
        {
            ...
            {
                rootobj.DIRECTION_ID = "20";
                rootobj.TYPEID = "WH_CONTRACTOR_GET";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GETFWHCTDetailsli", "GETFWHCTDetailsli : Method:" + jsondata + " , Input Data : " + inputdata));
        ...
        public async Task<dynamic> GetFWHRUli()
        {
            try
            {
                warehousereq rootobj = new warehousereq();
                rootobj.DIRECTION_ID = "1";
                rootobj.TYPEID = "URBAN_RURAL";
                DataTable dt = await APSWCFINWHCMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
            ...
            catch
            {
                ...
                //Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GetFWHRUlilogs", "GetFWHRUli : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while load RUral urban";
                return resultobj;

            }
        }

        public async Task<dynamic> GetFWHMandalli(warehousereq rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "1";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GetFWHMandallogs", "GetFWHMandal : Method:" + jsondata + " , Input Data : " + inputdata));
        ...
        public async Task<dynamic> SaveFWHLFDDETAILS(WHLoancl rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "20";
                rootobj.TYPEID = "110";
                DataTable dt = await APSWCWHCONTRACTORMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0 && dt.Rows[0][0].ToString() == "1")
                {
                    resultobj.StatusCode = 100;
                    resultobj.StatusMessage = "Data Saved Successfully";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "SaveFWHLREPAYDETAILS", "SaveFWHLREPAYDETAILS : Method:" + jsondata + " , Input Data : " + inputdata));
                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Save WH Bank Details";
                return resultobj;
            }
        }

        public async Task<dynamic> GETFWHLFDDetails(WHLoancl rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "20";
                rootobj.TYPEID = "FD_DETAILS_GET";
                DataTable dt = await APSWCFINWHCLMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GETFWHCLdetails", "GETFWHCLdetails : Method:" + jsondata + " , Input Data : " + inputdata));
                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while fetching  Details";
                return resultobj;
            }
        }


        public async Task<dynamic> GETFWHLFDMonths(WHLoancl rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "20";
                rootobj.TYPEID = "FD_MONTHS_GET";
                DataTable dt = await APSWCFINWHCLMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0 && dt.Rows[0][0].ToString() == "1")
                {
                    resultobj.StatusCode = 100;
        ...
        public async Task<dynamic> UPDFWHLFDDETAILS(WHLoancl rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "20";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "UPDFWHLFDDETAILS", "UPDFWHLFDDETAILS : Method:" + jsondata + " , Input Data : " + inputdata));
                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while update WH FD Details";
                return resultobj;
            }
        }

        public async Task<dynamic> GetWHRegionsli()
        {
            warehousereq rootobj = new warehousereq();
            try
            {
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GetFWHCRegionslogs", "GetFWHCRegions : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while load Regions";
                return resultobj;

            }
        }

        public async Task<dynamic> GetFWHDistrictsli(warehousereq rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "1";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GetFWHDistrictslilogs", "GetFWHDistrictsli : Method:" + jsondata + " , Input Data : " + inputdata));
        ...
        public async Task<dynamic> SaveFWHCLoandetails(WHLoancl rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "20";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "SaveFWHCLoandetails", "SaveFWHCLoandetails : Method:" + jsondata + " , Input Data : " + inputdata));
                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Save WH Loan Details";
                return resultobj;
            }
        }

        public async Task<dynamic> GETFWHLInstallmentdetails(WHLoancl rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "20";
                rootobj.TYPEID = "NIDA_QUATER_PRINCIPLE_SCH";
                DataTable dt = await APSWCFINWHCLMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
            ...
            catch (Exception ex)
            {
                ...
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GETFWHCLdetails", "GETFWHCLdetails : Method:" + jsondata + " , Input Data : " + inputdata));
                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while fetching WH Loan Details";
                return resultobj;
            }
        }

        public async Task<dynamic> GETFWHLIntrestdetails(WHLoancl rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "20";
                rootobj.TYPEID = "NIDA_ENTIRE_SCH"; //"NIDA_QUATER_INTREST_SCH";
                DataTable dt = await APSWCFINWHCLMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
        ...
        #region WareHouse Contractor Details
        public async Task<dynamic> SaveFWHCContractordetails(WHLoancl rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "20";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "SaveFWHCContractordetails", "SaveFWHCContractordetails : Method:" + jsondata + " , Input Data : " + inputdata));
                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Save WH Contractor Details";
                return resultobj;
            }
        }
        #endregion

        #region WareHouse Bank Master Details
        public async Task<dynamic> SaveFWHBANKMasterdetails(WHLoancl rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "20";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "SaveFWHBANKMaster", "SaveFWHBANKMaster : Method:" + jsondata + " , Input Data : " + inputdata));
                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Save WH Bank Details";
                return resultobj;
            }
        ...
        public async Task<dynamic> SaveFWHLREPAYDETAILS(WHLoancl rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "20";
        ...
        public async Task<dynamic> GETFWHBANKMasterdetails(WHLoancl rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "20";
                rootobj.TYPEID = "WH_BANK_DETAILS_GET";
                DataTable dt = await APSWCWHCONTRACTORMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
        ...
        public async Task<dynamic> GETFWHLBANKList(WHLoancl rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "20";
                rootobj.TYPEID = "WH_BANK_GET";
                DataTable dt = await APSWCWHCONTRACTORMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GETFWHLBANKList", "GETFWHLBANKList : Method:" + jsondata + " , Input Data : " + inputdata));
                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Fetching WH Bank Details";
                return resultobj;
            }
        }

        public async Task<dynamic> GETFWHLBANKDetailsList(WHLoancl rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "20";
                rootobj.TYPEID = "WH_BANK_NUM_GET";
                DataTable dt = await APSWCWHCONTRACTORMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GETFWHLBANKDetailsList", "GETFWHLBANKDetailsList : Method:" + jsondata + " , Input Data : " + inputdata));
                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Fetching WH Bank Details";
                return resultobj;
            }
        ...
        public async Task<dynamic> GETFWHREQUESTList(WHLoancl rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "20";
                rootobj.TYPEID = "REQUES_ID";
                DataTable dt = await APSWCWHCONTRACTORMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
        ...
        public async Task<dynamic> GETFWHLNOQUATERS(WHLoancl rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "20";
                rootobj.TYPEID = "NIDA_QUATERS";
                DataTable dt = await APSWCWHCONTRACTORMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
        ...
        #endregion
        #region WareHouse CT Loan Approval & Reject helpers
        public async Task<dynamic> GETFWHLREQUESTLI(warehousereq rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "20";
                rootobj.TYPEID = "LOAN_APPROVAL";
                DataTable dt = await APSWCFINWHCMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    //List<WHCTAPREJCL> obj = new List<WHCTAPREJCL>();
                    //foreach(DataRow dr in dt.Rows)
                    //{
                    //    WHCTAPREJCL WOBJ = new WHCTAPREJCL();
                    //    WOBJ.LOCATION_NAME = dr["constructioN_LOCATION_NAME"].ToString();
                    //    WOBJ.warehousE_CODE = dr["warehousE_CODE"].ToString();
                    //    WOBJ.wH_CONS_CAPACITY = dr["wH_CONS_CAPACITY"].ToString();
                    //    WOBJ.status = dr["status"].ToString() == "0" ? "Pending" : "Approve";
                    //    WOBJ.requesT_ID = dr["requesT_ID"].ToString();
                    //    WOBJ.department= Convert.ToString(dr["department"]);
                    //    WOBJ.estimatioN_AMOUNT= dr["estimatioN_AMOUNT"].ToString(); 
                    //    WOBJ.inserteD_BY= dr["inserteD_BY"].ToString();
                    //    obj.Add(WOBJ);
                    //}
                    resultobj.StatusCode = 100;
                    resultobj.StatusMessage = "Data Loaded Successfully";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GetFWHREQUESTlogs", "GetFWHREQUEST : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while load Data";
                return resultobj;
        ...
        public async Task<dynamic> GETFWHLDRPLIST(warehousereq rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "20";
                rootobj.TYPEID = "WH_DRP_GET";
                DataTable dt = await APSWCFINWHCMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
        ...
        public async Task<dynamic> GETFWHLSDATALIST(warehousereq rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "20";
                rootobj.TYPEID = "WH_SLOAN_GET";
                DataTable dt = await APSWCFINWHCMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
        ...
        #endregion
        #region WareHouse Construction & Loan Module SP

        public async Task<DataTable> APSWCFINWHCMasterSp(warehousereq objMa)
        {
            SqlConnection sqlcon = new SqlConnection(_connectionString);
            SqlCommand cmd = new SqlCommand();
            DataTable dt = new DataTable();
        ...
        public async Task<DataTable> APSWCFINWHCGETSp(warehousereq objMa)
        {
            SqlConnection sqlcon = new SqlConnection(_connectionString);
            SqlCommand cmd = new SqlCommand();
            DataTable dt = new DataTable();
        ...
        public async Task<DataTable> APSWCFINWHCLMasterSp(WHLoancl objMa)
        {
            SqlConnection sqlcon = new SqlConnection(_connectionString);
            SqlCommand cmd = new SqlCommand();
            DataTable dt = new DataTable();
        ...
        public async Task<DataTable> APSWCWHCONTRACTORMasterSp(WHLoancl objMa)
        {
            SqlConnection sqlcon = new SqlConnection(_connectionString);
            SqlCommand cmd = new SqlCommand();
            DataTable dt = new DataTable();
        ...
        public async Task<dynamic> GETFWHLEMIDetails(WHLoancl rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "20";
                rootobj.TYPEID = "LOAN_DETAILS_EMI_CHAT_GET";
                DataTable dt = await APSWCFINWHCLMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
        ...
        public async Task<dynamic> GETFWHLoanDetails(WHLoancl rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "20";
                rootobj.TYPEID = "LOAN_DETAILS_GET";
                DataTable dt = await APSWCFINWHCLMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
        ...
        public async Task<dynamic> UPDFWHBANKMasterdetails(WHLoancl rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "20";
        ...
        public async Task<dynamic> WHsaveempapprovalApproval(MasterSp objMa)
        {
            try
            {

                objMa.DIRECTION_ID = "20";
                DataTable dt = await APSWCMasterSp(objMa);
                if (dt != null && dt.Rows.Count > 0)
                {
                    if (dt.Rows[0]["RTN_ID"].ToString() == "1")
            ...
            catch (Exception ex)
            {
                ...
                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Save the Data";
                return resultobj;
            }
        }

        public async Task<dynamic> WHloanapprovalupdateApproval(MasterSp objMa)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(objMa);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log_Exception(exPathToSave, "WHupdateemployeeloanApprove : Method:" + jsondata + " , Input Data : " + inputdata));
        ...
        public async Task<dynamic> whHistorydetails(MasterSp objMa)
        {
            try
            {

                objMa.DIRECTION_ID = "20";
                objMa.TYPEID = "WH_LOAN_HISTORY";
                DataTable dt = await APSWCMasterSp(objMa);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(objMa);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log_Exception(exPathToSave, " whHistorydetails: Method:" + jsondata + " , Input Data : " + inputdata));
        ...
        public async Task<dynamic> servicePayrefund(MasterSp objMa)
        {
            try
            {
        ...
        public async Task<dynamic> GETFWHPREEMICHAT(WHLoancl rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "20";
                rootobj.TYPEID = "EMI_CHAT_PRE_CAL";
                DataTable dt = await APSWCFINWHCLMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
        ...
        public async Task<dynamic> GETFWHLEMPREQHIST(WHLoancl rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "20";
                rootobj.TYPEID = "WH_EMP_LOAN_HISTORY";
                DataTable dt = await APSWCFINWHCLMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
        ...
        public async Task<dynamic> SendSMS(MasterSp rootobj)
        {
            ...
            try
            {
                ...
                string otpnumber = GetRandomText();
                string ReferenceID = GetRefrenceID();
                rootobj.INPUT_03 = otpnumber;
                rootobj.INPUT_04 = ReferenceID;
                string message = "Dear " + rootobj.INPUT_02 + ", your OTP " + otpnumber + " for registration as " + rootobj.INPUT_05 + "\n (APSWC)-GOVTAP";
                //this.message = "Dear " + this.empname + "your OTP  " + this.randnum + " for registration as farmer (APSWC) -Dir.EDS.AP";
                DataTable dt = await APSWCMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {


                    string status = sms.SendSMS(rootobj.INPUT_01, message, "");

                    if (status.Contains("402"))
                    {
                        string inputdata = JsonConvert.SerializeObject(rootobj);
                        Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(savePath, "SendSMSLogs", "SendSMS : Method:" + status + " , Input Data : " + inputdata));

                        resultobj.StatusCode = 100;
                        resultobj.RefernceID = ReferenceID;
                        resultobj.StatusMessage = "Successfully OTP send your Register Mobile Number";
                    ...
                    else
                    {
                        ...
                        string inputdata = JsonConvert.SerializeObject(rootobj);
                        Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "SendSMSLogs", "SendSMS : Method:" + status + " , Input Data : " + inputdata));

                        resultobj.StatusCode = 102;
                        resultobj.RefernceID = "";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "SendSMSLogs", "SendSMS : Method:" + jsondata + " , Input Data : " + inputdata));
                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Sending  SMS";
                return resultobj;
            }
        ...
        public async Task<dynamic> GenerateOTP(MasterSp rootobj)
        {
            dynamic response = new ExpandoObject();

            rootobj.DIRECTION_ID = "16";
            rootobj.TYPEID = "106";
            try
            {
                ...
                if (_mapsserverpath.Contains("uat."))
                {

                    string ReferenceID = DateTime.Now.Ticks.ToString() + RandomNumber(1000, 9999).ToString();
                    rootobj.INPUT_03 = "654321";
                    rootobj.INPUT_04 = ReferenceID;
                    rootobj.INPUT_08 = "1007478584743465426";
                    DataTable dt = await APSWCMasterSp(rootobj);
                    string inputdata = JsonConvert.SerializeObject(rootobj);
                    Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(savePath, "SendSMSLogs", "SendSMS : Method:" + dt.Rows[0][0].ToString() + " , Input Data : " + inputdata));

                    resultobj.StatusCode = 100;
                    resultobj.RefernceID = ReferenceID;
                    resultobj.StatusMessage = "Successfully OTP send to your Mobile Number";
                ...
                else
                {
                    ...
                    string message = "Your OTP to register/access APSWOS is " + otpnumber + ". It will be valid for 10 minutes.\n- APSWC";
                    //  string message = "Dear " + rootobj.INPUT_02 + ", your OTP " + otpnumber + " for registration as " + rootobj.INPUT_05 + "\n (APSWC)-GOVTAP";
                    DataTable dt = await APSWCMasterSp(rootobj);
                    if (dt != null && dt.Rows.Count > 0 && dt.Rows[0][0].ToString() == "1")
                    {

                        string status = sms.SendSMS(rootobj.INPUT_01, message, rootobj.INPUT_08);
                        rootobj.TYPEID = "108";
                        rootobj.INPUT_10 = status;
                        DataTable dt1 = await APSWCMasterSp(rootobj);
        ...
        public async Task<dynamic> VerifyOTPNumber(MasterSp rootobj)
        {
            dynamic response = new ExpandoObject();
            ...
            try
            {
                ...
                if (dt != null && dt.Rows.Count > 0 && dt.Rows[0][0].ToString() == "1")
                {
                    ...
                    resultobj.StatusMessage = "Successfully OTP Verified";
                ...
                else
                {
                    ...
                    resultobj.StatusMessage = "OTP Verification Failed,Please try again...";
                    return resultobj;
                }
        ...
        public async Task<dynamic> VerifyOTP(MasterSp rootobj)
        {
            dynamic response = new ExpandoObject();
            ...
            try
            {
                ...
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(savePath, "VerifyOTPLogs", "VerifyOTP ,Input Data : " + inputdata + "_" + dt.Rows[0][0].ToString()));
                ...
                if (dt != null && dt.Rows.Count > 0 && dt.Rows[0][0].ToString() == "2")
                {
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "VerifyOTPLogs", "SendSMS : Method:" + jsondata + " , Input Data : " + inputdata));
                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Sending  SMS";
                return resultobj;
            }
        ...
        private string GetRefrenceID()
        {

            StringBuilder refrandomText = new StringBuilder();
        ...
        public async Task<dynamic> GetTaxApproveReject(MasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "10";
                rootobj.TYPEID = rootobj.INPUT_06 == "APPROVE" ? "102" : rootobj.INPUT_06 == "REJECT" ? "103" : "";
                DataTable dt = await APSWCMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0 && dt.Rows[0][0].ToString() == "1")
                {
                    resultobj.StatusCode = 100;
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log_Exception(exPathToSave, "GetTaxApproveRejectLogs : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while load Tax Approve or Reject Details";
                return resultobj;

            }
        }

        public async Task<dynamic> GetTaxReqHistory(MasterSp rootobj)
        {

            try
            {
                rootobj.DIRECTION_ID = "10";
                rootobj.TYPEID = rootobj.INPUT_02 == "TAX_HISTORY" ? "EMP_LOAN_HISTORY" : rootobj.INPUT_02 == "APPR_HISTORY" ? "TAX_REQ_HISTORY" : "";
                DataTable dt = await APSWCMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GetTaxReqHistorylogs", "GetTaxReqHistory : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Getting Tax Request History";
                return resultobj;

            }
        }

        public async Task<dynamic> GetImprestBillDetails(EmployeeMasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "10";
                rootobj.TYPEID = "BILL_OFFICER";
            ...
            catch (Exception ex)
            {
                ...
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GetImprestBillDetailsLogs", "GetImprestBillDetails: Method:" + jsondata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Gettig Imprest Approval Bill";
                return resultobj;
        ...
        public async Task<dynamic> GetImprestPaymentDetails(MasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "10";
            ...
            catch (Exception ex)
            {
                ...
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GetImprestPaymentDetailsLogs", "GetImprestPaymentDetails : Method:" + jsondata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Gettig Imprest Approval Bill List";
                return resultobj;
        ...
        public async Task<dynamic> GetInspectionYears()
        {
            EmployeeMasterSp rootobj = new EmployeeMasterSp();
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Getting Years";
                return resultobj;

            }
        }
        public async Task<dynamic> GetInspectionYears_web()
        {
            MasterSp rootobj = new MasterSp();
            try
            {
                rootobj.DIRECTION_ID = "25";
                rootobj.TYPEID = "101";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GetInspectionYearslogs", "GetInspectionYears : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while load Inspection Years";
                return resultobj;

            }
        }
        public async Task<dynamic> GetMQCSectionList()
        {
            MasterSp rootobj = new MasterSp();
            try
            {
                rootobj.DIRECTION_ID = "8";
                rootobj.TYPEID = "M&QC_SECTION";
            ...
            catch (Exception ex)
            {
                ...
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GetMQCSectionListlogs", "GetMQCSectionList : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Getting M & QC Section List";
        ...
        public async Task<dynamic> GetregsecDetails(MasterSp rootobj)
        {

            try
            {
                rootobj.DIRECTION_ID = "1";
                rootobj.TYPEID = "WORK_LOCATION_GET";
                DataTable dt = await APSWCMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "Getregionsectionlogs", "Getregionsectionlogs : Method:" + jsondata + " , Input Data : " + inputdata));
        ...
        public async Task<dynamic> whImprestdetails(MasterSp objMa)
        {
            try
            {

                objMa.DIRECTION_ID = "10";
                objMa.TYPEID = "BILL_OFFICER";
                DataTable dt = await APSWCMasterSp(objMa);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(objMa);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log_Exception(exPathToSave, " whImprestdetails: Method:" + jsondata + " , Input Data : " + inputdata));
        ...
        public async Task<dynamic> saveImprestApproval(MasterSp objMa)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(objMa);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log_Exception(exPathToSave, "saveImprestApprovallogs : Method:" + jsondata + " , Input Data : " + inputdata));
        ...
        public async Task<dynamic> updateimprestapproval(MasterSp objMa)
        {
            try
            {
        ...
        public async Task<dynamic> Saveimprestpprovaldetails(MasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "10";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "SaveimprestApprovalDetailsLogs", "SaveimprestApprovalDetailsLogs : Method:" + jsondata + " , Input Data : " + inputdata));
        ...
        public async Task<dynamic> savepushbackImprestApproval(MasterSp objMa)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(objMa);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log_Exception(exPathToSave, "Saveimprestpushbacklogs : Method:" + jsondata + " , Input Data : " + inputdata));
        ...
        public async Task<dynamic> UPDFWHCONTRDETAILS(WHLoancl rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "20";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "UPDFWHCONTRDETAILS", "UPDFWHCONTRDETAILS : Method:" + jsondata + " , Input Data : " + inputdata));
                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while update WH Contractor Details";
                return resultobj;
            }
        }

        public async Task<dynamic> GetWHLeasedCompartemtns(MasterSp rootobj)
        {
            ...
            catch (Exception ex)
            {
                ...
                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while load Leased Comparment Details";
                return resultobj;

            }
        }

        public async Task<dynamic> SaveWarehousereqdetails(WHLoancl rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "20";
        ...
        public async Task<dynamic> GetWHQuestionsResponse(MasterSp rootobj)
        {
            ...
            try
            {
                ...
                rootobj.DIRECTION_ID = "8";
                rootobj.TYPEID = "WH_QUESTION_RESPONSE";
                DataTable dt = await APSWCMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
            ...
            catch (Exception ex)
            {
                ...
                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Getting Questions Response Details";
                return resultobj;

            }
        }

        public async Task<dynamic> SaveObservationATR(EmployeeMasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "102";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "SaveObservationATRLogs", "SaveObservationATR : Method:" + jsondata + " , Input Data : " + inputdata));
        ...
        public async Task<dynamic> SendDetails(EmployeeMasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "101";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "SendDetailslogs", "SendDetailslogs : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Save the Details";
                return resultobj;
        ...
        public async Task<dynamic> CancelDetails(EmployeeMasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "101";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "CancelDetailslogs", "CancelDetailslogs : Method:" + jsondata + " , Input Data : " + inputdata));
        ...
        public async Task<dynamic> pushbackDetails(EmployeeMasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "101";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "SavePushbacklogs", "SavePushbacklogs : Method:" + jsondata + " , Input Data : " + inputdata));
        ...
        public async Task<dynamic> PageSensitiveData(MasterSp rootobj)
        {
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "PageSensitiveDatalogs", "PageSensitiveData : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Saving Page Sensitive Information";
                return resultobj;
        ...
        public async Task<dynamic> SaveReimbursementtpushback(MasterSp rootobj)
        {
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "SaveReimbursementtpushbacklogs", "SaveReimbursementtpushback : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Save PushBack Details";
                return resultobj;

            }
        }

        public async Task<dynamic> SaveReimbApproveRequest(MasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "10";
                rootobj.TYPEID = rootobj.INPUT_15 == "REQUEST" ? "102" : rootobj.INPUT_15 == "APPROVE" ? "103" : "";
                DataTable dt = await APSWCMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0 && dt.Rows[0][0].ToString() == "1")
                {
                    resultobj.StatusCode = 100;
        ...
        public async Task<dynamic> SaveImrestCancelUpdate(MasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "10";
                rootobj.TYPEID = rootobj.INPUT_15 == "UPDATE" ? "106" : rootobj.INPUT_15 == "CANCEL" ? "107" : "";
                DataTable dt = await APSWCMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0 && dt.Rows[0][0].ToString() == "1")
                {
                    resultobj.StatusCode = 100;
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log_Exception(exPathToSave, "SaveImrestCancelUpdateLogs : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Save Imprest Details";
                return resultobj;
        ...
        public async Task<dynamic> serviceSendDetails(MasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "5";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "SaveserviceSendlogs", "SaveserviceSendlogs : Method:" + jsondata + " , Input Data : " + inputdata));
        ...
        public async Task<dynamic> serviceCancelDetails(MasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "5";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "serviceCancelDetailslogs", "serviceCancelDetailslogs : Method:" + jsondata + " , Input Data : " + inputdata));
        ...
        public async Task<dynamic> servicepushbackDetails(MasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "5";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "SaveservicePushbacklogs", "SaveservicePushbacklogs : Method:" + jsondata + " , Input Data : " + inputdata));
        ...
        public async Task<dynamic> LoanpushbackDetails(EmployeeMasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "101";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "SaveloanPushbackDetailslogs", "SaveloanPushbackDetailslogs : Method:" + jsondata + " , Input Data : " + inputdata));
        ...
        public async Task<dynamic> LoanCancelDetails(EmployeeMasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "101";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "SubmitloanCancelDetails", "SubmitloanCancelDetails : Method:" + jsondata + " , Input Data : " + inputdata));
        ...
        public async Task<dynamic> loanSendDetails(EmployeeMasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "101";
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "SaveloanSendlogs", "SaveloanSendlogs : Method:" + jsondata + " , Input Data : " + inputdata));
        ...
        public async Task<dynamic> InstallMentDetails(EmployeeMasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "101";
                rootobj.TYPEID = "INSTALLMENTS_GET";
                DataTable dt = await EmployeeAPSWCMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "UpdateSactionDetailslogs", "UpdateSactionDetailslogs : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while get  Details";
                return resultobj;
        ...
        public async Task<dynamic> DetailsUpdate(EmployeeMasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "101";
        ...
        public async Task<dynamic> GETFWHLWIFLOANList(WHLoancl rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "20";
                rootobj.TYPEID = rootobj.TYPEID;
                DataTable dt = await APSWCWHCONTRACTORMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GETFWHLWIFLOANList", "GETFWHLWIFLOANList : Method:" + jsondata + " , Input Data : " + inputdata));
                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Fetching WH WIF LOAN Details";
                return resultobj;
            }
        }


        public async Task<dynamic> MedicalSendCancelDetails(EmployeeMasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "101";
                rootobj.TYPEID = rootobj.INPUT_15 == "SEND" ? "217" : rootobj.INPUT_15 == "CANCEL" ? "218" : "";
                DataTable dt = await EmployeeAPSWCMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0 && dt.Rows[0][0].ToString() == "1")
                {
                    resultobj.StatusCode = 100;
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "MedicalSendCancelDetailslogs", "MedicalSendCancelDetails : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Saving the Medical Send/Cancel Details";
                return resultobj;
        ...
        public async Task<dynamic> ServiceSendCancelDetails(MasterSp rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "5";
                rootobj.TYPEID = rootobj.INPUT_15 == "SEND" ? "209" : rootobj.INPUT_15 == "CANCEL" ? "210" : "";
                DataTable dt = await APSWCMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0 && dt.Rows[0][0].ToString() == "1")
                {
                    resultobj.StatusCode = 100;
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "ServiceSendCancelDetailslogs", "ServiceSendCancelDetails : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Submit the Service Request Send/Cancel Details";
                return resultobj;

            }
        }

        public async Task<dynamic> GetHeadOfficesList()
        {
            try
            {
                MasterSp m = new MasterSp();
                m.DIRECTION_ID = "1";
                m.TYPEID = "HEAD_OFFICE";
                //return await APSWCMasterSp(m);
                DataTable dt = await APSWCMasterSp(m);
                if (dt != null && dt.Rows.Count > 0)
                {
            ...
            catch (Exception ex)
            {
                ...
                //string mappath = Server.MapPath("UpdateMailMobileFormLogs");
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GetHeadOfficesListlogs", "GetHeadOfficesList:Method:" + jsondata));
                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while load HeadOffices Details";
                return resultobj;
            }
        }

        public async Task<dynamic> WeigbBridgeWeightCapture(WHLoancl rootobj)
        {
            try
            {
                rootobj.DIRECTION_ID = "2";
                ...
                {
                    resultobj.StatusCode = 102;
                    resultobj.StatusMessage = "Inserted Failed";
                }
                return resultobj;
            }
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "WeigbBridgeWeightCapture", "WeigbBridgeWeightCapture : Method:" + jsondata + " , Input Data : " + inputdata));
                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while Insert";
                return resultobj;
            }
        }
        ...
        public async Task<dynamic> GetTechnicalDeadStockRegister(MasterSp rootobj)
        {

            try
            {
                rootobj.DIRECTION_ID = "13";
                rootobj.TYPEID = "TECHNICAL_DEAD_STOCK_REG";
                DataTable dt = await APSWCMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GetTechnicalDeadStockRegisterLogs", "GetTechnicalDeadStockRegister : Input Data : " + inputdata + ", Method:" + jsondata));
        ...
        public async Task<dynamic> GetAckRegister(MasterSp rootobj)
        {

            try
            {
                rootobj.DIRECTION_ID = "13";
                rootobj.TYPEID = "ACK_REGISTER";
                DataTable dt = await APSWCMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GetAckRegisterLogs", "GetAckRegister : Input Data : " + inputdata + ", Method:" + jsondata));
        ...
        public async Task<dynamic> GetInspectionMonths()
        {
            MasterSp rootobj = new MasterSp();
            try
            {
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GetInspectionMonthslogs", "GetInspectionMonths : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while load Inspection Months";
                return resultobj;

            }
        }

        public async Task<dynamic> GetRegions()
        {
            MasterSp rootobj = new MasterSp();
            try
            {
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "GetRegionslogs", "GetRegions : Method:" + jsondata + " , Input Data : " + inputdata));

                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while load Regions List";
                return resultobj;
        ...
        public async Task<dynamic> GetDistandWHType(MasterSp rootobj)
        {

            try
            {
                rootobj.DIRECTION_ID = "25";
                //rootobj.TYPEID = rootobj.INPUT_03 == "Districts" ? "104" : "105";
                DataTable dt = await APSWCMasterSp(rootobj);
                if (dt != null && dt.Rows.Count > 0)
                {
                    resultobj.StatusCode = 100;
        ...
        public async Task<dynamic> GetMonthWiseAbstract(MasterSp rootobj)
        {
            ...
            catch (Exception ex)
            {
                ...
                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while load Month wise Abstract Details";
                return resultobj;

            }
        }

        public async Task<dynamic> GetAnnualInspectionPlan(MasterSp rootobj)
        {
            ...
            catch (Exception ex)
            {
                ...
                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while load Annual Inspection Plan Details";
                return resultobj;

            }
        }

        public async Task<dynamic> GetScheduleDetails(MasterSp rootobj)
        {
            ...
            catch (Exception ex)
            {
                ...
                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while load Inspection Scheduled Details";
                return resultobj;

            }
        }

        public async Task<dynamic> GetQuestionariesResponse(MasterSp rootobj)
        {
            ...
            catch (Exception ex)
            {
                ...
                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while load Questionaries and Response Details";
                return resultobj;

            }
        }

        public async Task<dynamic> GetImagesVideosList(MasterSp rootobj)
        {
            ...
            catch (Exception ex)
            {
                ...
                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while load Inspection Images and Videos";
                return resultobj;

            }
        }

        public async Task<dynamic> GetATRStatusResponse(MasterSp rootobj)
        {
            ...
            catch (Exception ex)
            {
                ...
                resultobj.StatusCode = 102;
                resultobj.StatusMessage = "Error Occured while load ATR Response List";
                return resultobj;

            }
        }

        public async Task<dynamic> DepositorSaveSpaceReservation(EmployeeMasterSp rootobj)
        {
            ...
            catch (Exception ex)
            {
                string jsondata = JsonConvert.SerializeObject(ex.Message);
                string inputdata = JsonConvert.SerializeObject(rootobj);
                Task WriteTask = Task.Factory.StartNew(() => Logfile.Write_Log(exPathToSave, "DepositorSpaceReservationDetailslogs", "DepositorSpaceReservationDetails : Method:" + jsondata + " , Input Data : " + inputdata));
