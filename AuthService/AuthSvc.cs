...
namespace AuthService
{
    public class AuthSvc:IAuthService
    {
        ...
        public AuthSvc(UserManager<ApplicationUser> userManager,IOptions<AppSettings> appSettings, IOptions<DataProtectionKeys> dataProtectionKeys, IServiceProvider provider)
        {
        ...
        public Task<TokenResponseModel> Auth(LoginViewModel model)
        {
